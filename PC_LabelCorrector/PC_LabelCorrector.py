...
class PC_LabelCorrector:
    def __init__(self, detect_outlier_with_ocpc = True,  k_max = 2, alfa = -0.7861929761486334, lamda = 0.43822967992590967, close = False, buffer = 1000, f = 1.7358761473640474, 
                 outlier_rate = 0.1):
        """
